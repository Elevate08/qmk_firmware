...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        MD_BOOT, KC_BRID, KC_BRIU, _______, _______, RGB_VAD, RGB_VAI, KC_MPRV, KC_MNXT, KC_MPLY, KC_MUTE, KC_VOLD, KC_VOLU,            KC_P7,   KC_P8,   KC_P9, \
        ...
        _______, RGB_HUI, RGB_SAI, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   KC_P1,   KC_P2,   KC_P3, \
        ...
        _______, _______, _______,                   RGB_TOG,                            _______, _______, _______, _______,            KC_P0,   KC_PDOT, KC_PENT\
    ),
    /*
    [X] = LAYOUT(
